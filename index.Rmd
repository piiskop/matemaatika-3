...
description: "kolmanda kooliastme matemaatika õppe keskkond"
lang: et
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'Kolmanda kooliastme<br/>matemaatika <br/>õppe keskkond' }`"
...
if (knitr::is_latex_output()) {
  "[veebiteisend](http://matemaatika-3.ons.ee)"
}
